    ...
    namespace Forms
    {
        public class NoteColourForm
        {
            ...
            public void NoteSizeBoxEvent(object sender, EventArgs e) {
                switch (NoteSizeBox.SelectedIndex) {
                    case 0: { _MouseCtrl.ActivePatrial = PartialNote.Full; break; }
                    case 1: { _MouseCtrl.ActivePatrial = PartialNote.Half; break; }
                    case 2: { _MouseCtrl.ActivePatrial = PartialNote.Quarter; break; }
                    case 3: { _MouseCtrl.ActivePatrial = PartialNote.Eighth; break; }
                }
            }
